...
//     body.addEventListener(button, add(onclick, Array(function)))
//     random.floor(Math.length.button(function.onclick(Array))) {
//         button.onclick(Array, function(add.Array.floor.random))
//         document.querySelector(function.Array.random.floor())
//         Array.floor(random.function(add.button(function)))
//     }
// }
